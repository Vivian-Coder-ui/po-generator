...
st.title("📄 信可美採購單 PDF 轉單系統")
st.write("請選擇供應商與交易條件，系統將直接產生正式採購單畫面，按 Ctrl+P 即可儲存為完美 PDF！")
...
st.markdown("---")
st.subheader("📋 採購單預覽畫面（請直接按右鍵或 Ctrl+P 列印成 PDF）")

# 產生正式排版的 HTML 採購單預覽
html_code = f"""
<div style="background: white; padding: 30px; border: 1px solid #ccc; border-radius: 8px; color: #333; font-family: Arial, sans-serif;">
    <h2 style="color: #1a365d; margin-bottom: 5px;">信可美股份有限公司</h2>
    <p style="color: #666; margin-top: 0;">PURCHASE ORDER (正式採購單)</p>
    <hr style="border: 1px solid #1a365d;">
    
    <table style="width: 100%; margin-top: 20px;">
        <tr>
            <td style="width: 50%; vertical-align: top; background: #f8fafc; padding: 10px; border-radius: 5px;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        ...
        <tbody>
            <tr>
                ...
                <td style="padding: 10px; border: 1px solid #cbd5e1;">盤形彈簧 DB502530<br><small>規格: 50x25.4x3.0xH4.1 / 材質: 51CrV4 (DIN 2093 公差)</small></td>
    ...
    <div style="text-align: right; font-size: 14pt; font-weight: bold; margin-top: 15px;">
        未稅總金額 (Total RMB)：RMB {total_amount:,.2f}
    </div>

    <div style="background: #f1f5f9; padding: 12px; border-radius: 5px; margin-top: 20px; font-size: 10pt;">
...
st.info("💡 **小撇步**：畫面上顯示的就是完美排版的採購單。直接按下鍵盤的 **`Ctrl + P`**（或 Mac 的 `Cmd + P`），印表機目的地選擇 **「另存為 PDF」**，就能馬上拿到最完美的正式 PDF 採購單囉！")
